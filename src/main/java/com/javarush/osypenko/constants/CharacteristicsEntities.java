...
public class CharacteristicsEntities {
    ...
    static  {
        characteristicsEntities.put(EntitiesType.WOLF, new ObjectPrefs("Волк", "\uD83D\uDC3A", 50, 30, 3, 6, 25));
        characteristicsEntities.put(EntitiesType.SNAKE, new ObjectPrefs("Удав", "\uD83D\uDC0D", 15, 30, 1, 2, 7.5));
        characteristicsEntities.put(EntitiesType.FOX, new ObjectPrefs("Лиса", "\uD83E\uDD8A", 8, 30, 2, 1, 4));
        characteristicsEntities.put(EntitiesType.BEAR, new ObjectPrefs("Медведь", "\uD83D\uDC3B", 500, 5, 2, 50, 250));
        characteristicsEntities.put(EntitiesType.EAGLE, new ObjectPrefs("Орел", "\uD83E\uDD85", 6, 20, 3, 0.5, 3));
        characteristicsEntities.put(EntitiesType.HORSE, new ObjectPrefs("Лошадь", "\uD83D\uDC0E", 400, 20, 4, 30, 200));
        characteristicsEntities.put(EntitiesType.DEER, new ObjectPrefs("Олень", "\uD83E\uDD8C", 300, 20, 4, 25, 150));
        characteristicsEntities.put(EntitiesType.RABBIT, new ObjectPrefs("Кролик", "\uD83D\uDC07", 2, 150, 2, 0.25, 1));
        characteristicsEntities.put(EntitiesType.MOUSE, new ObjectPrefs("Мышь", "\uD83D\uDC01", 0.05, 500, 1, 0.01, 0.02));
        characteristicsEntities.put(EntitiesType.GOAT, new ObjectPrefs("Коза", "\uD83D\uDC10", 60, 140, 3, 7, 30));
        characteristicsEntities.put(EntitiesType.SHEEP, new ObjectPrefs("Овца", "\uD83D\uDC11", 70, 140, 3, 10, 35));
        characteristicsEntities.put(EntitiesType.BOAR, new ObjectPrefs("Кабан", "\uD83D\uDC17", 400, 50,2,25, 200));
        characteristicsEntities.put(EntitiesType.BUFFALO, new ObjectPrefs("Буйвол", "\uD83D\uDC03", 700, 10, 3, 50, 350));
